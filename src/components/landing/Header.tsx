					...
					{isAuthenticated ? (
						<>
							...
							<Link to="/dashboard">
								<button
									type="button"
									className="flex items-center gap-2 rounded-md bg-primary hover:bg-primary/90 px-3 py-1.5 text-sm font-medium text-primary-foreground transition-colors"
								>
								...
								{isAuthenticated ? (
									<>
										...
										<Link
											...
											onClick={() => setMobileMenuOpen(false)}
										>
											<div className="flex items-center justify-center gap-2 rounded-md bg-primary py-2.5 text-sm font-medium text-primary-foreground">
												<LayoutDashboard className="h-4 w-4" />
												Dashboard
											</div>
										</Link>
									...
									<button
										...
										className="rounded-md bg-primary py-2.5 text-sm font-medium text-primary-foreground"
									>
										Get Started
									</button>
								)}
